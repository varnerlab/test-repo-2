...
"""
function _recursive_compound_parser(q::Queue, atoms::Queue{Char}, numbers::Queue{Char}, result::Dict{Char,Float64})
...
"""
    recursive_compound_parser(compound_string::String) -> Dict{Char,Float64}
"""
function recursive_compound_parser(compound_string::String)::Dict{Char,Float64}
    ...
    # recursive descent -
    _recursive_compound_parser(q, atoms, numbers, composition_dictionary);
